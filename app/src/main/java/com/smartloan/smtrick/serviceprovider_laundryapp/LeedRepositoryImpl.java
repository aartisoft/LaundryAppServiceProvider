...
//    }
    ...
    @Override
    public void readServiceProvidersById(String Id, final CallBack callBack) {
        final Query query = Constant.SERVICE_PROVIDER_TABLE_REF.orderByChild("userid").equalTo(Id);
        fireBaseNotifyChange(query, new CallBack() {
            @Override
            public void onSuccess(Object object) {
                if (object != null) {
    ...
    @Override
    public void sendRequestToApproved(Requests request, final CallBack callBack) {
        DatabaseReference databaseReference = Constant.APPROVED_REQUESTS_TABLE_REF.child(request.getRequestId());
        fireBaseCreate(databaseReference, request, new CallBack() {
            @Override
            public void onSuccess(Object object) {
                callBack.onSuccess(object);
    ...
    @Override
    public void sendRequestToComplete(Requests request, final CallBack callBack) {
        DatabaseReference databaseReference = Constant.COMPLETED_REQUESTS_TABLE_REF.child(request.getRequestId());
        fireBaseCreate(databaseReference, request, new CallBack() {
            @Override
            public void onSuccess(Object object) {
                callBack.onSuccess(object);
    ...
    @Override
    public void updateServiceProvider(String leedId, Map leedsMap, final CallBack callBack) {
        final DatabaseReference databaseReference = Constant.SERVICE_PROVIDER_TABLE_REF.child(leedId);
        fireBaseUpdateChildren(databaseReference, leedsMap, new CallBack() {
            @Override
            public void onSuccess(Object object) {
    ...
    @Override
    public void readAdmin(final CallBack callBack) {
        final Query query = Constant.ADMIN_TABLE_REF;
        fireBaseNotifyChange(query, new CallBack() {
            @Override
            public void onSuccess(Object object) {
                if (object != null) {
